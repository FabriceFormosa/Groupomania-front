  ...
  <header class="p-3  bg-secondary text-dark  ">
    ...
    <div class="container">
      <div class="d-flex flex-column ">
        ...
        <div class="mx-auto "><span>{{ current_user_last_name }} {{ current_user_name }} <i
              v-if="current_user_admin == 'false'" class="fa-solid fa-user ps-2"></i> <i
              v-if="current_user_admin == 'true'" class="fa-solid fa-user-gear ps-2"></i>
            <span><i id="i_logout" @click="logOut" v-if="this.isLoggedIn"
                class="fa-solid fa-arrow-right-from-bracket ps-2"></i></span></span>
        </div>
        <div class="mx-auto">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul v-if="this.isLoggedIn" class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              ...
              <li>
                <router-link to="/viewprofile" class="nav-link px-2 text-dark">View Profile</router-link>
              </li>
              <li v-if="current_user_admin == 'true'">
                <router-link to="/createprofile" class="nav-link px-2 text-dark">Create Profile</router-link>
              </li>
              <li>
                <router-link to="/updateprofile" class="nav-link px-2 text-dark">Update Profile</router-link>
              </li>
