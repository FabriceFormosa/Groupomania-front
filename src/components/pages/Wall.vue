...
<template>
    ...
    <div v-if="currentUser" class="container-sm mt-5">
        ...
        <div v-for="post in posts">
            ...
            <Card :name_owner_post="post.user.name" :last_name_owner_post="post.user.lastName"
                :avatar_owner_post="post.user.avatar" :email_owner_post="post.user.email"
                :content_owner_post="post.content" :url_img_owner_post="post.imageUrl"
                :comments_owner_post="post.comments" :id_owner_post="post.id" :createdAt="post.createdAt">
            </Card>
        </div>
