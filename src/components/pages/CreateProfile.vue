		...
		<div class="card">
			...
			<form class="card-body">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
						<input type="email" class="form-control" placeholder="lastname.name@groupomania.fr"
							v-model="email" required invalid>
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
						<input type="password" class="form-control" placeholder="type a new password" v-model="password"
							required invalid>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="text-center text-secondary">
						<input type="submit" class="btn btn-primary px-4" value="Create Profile"
							@click.prevent="() => submitForm(this.email, this.password, this.name, this.lastName, this.service, this.admin)">
					</div>
				</div>
			</form>
