			...
			<div class="card-body">
				<div class="row mb-3 ">
					...
					<div class="col-sm-9">
						...
						<div v-if="imageDataAvatar" class="image-input"
							:style="{ 'background-image': `url(${imageDataAvatar})` }"></div>
						<input id="file-input-avatar" class="file-input" ref="fileInput" type="file"
							@input="onSelectFileAvatar" accept="image/*">
					</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
						<input type="email" class="form-control" placeholder="lastname.name@groupomania.fr"
							v-model="email" required invalid v-bind:readonly="isReadOnly">
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-8 text-secondary">
						<input v-if="!this.show_pwd" type="password" class="form-control"
							placeholder="type a new password please" v-model="password" required invalid>
						<input v-if="this.show_pwd" type="text" class="form-control"
							placeholder="type a new password please" v-model="password" required invalid>
					</div>
					<div class="col-sm-1 text-secondary">
						<span><i v-if="!this.show_pwd" class="fa-regular fa-eye-slash" @click="showPwd"></i><i
								v-if="this.show_pwd" class="fa-regular fa-eye" @click="hidePwd"></i></span>
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
						<input type="name" class="form-control" placeholder="type a new name" v-model="name" required
							invalid>
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
						<input type="lastName" class="form-control" placeholder="type a new last name"
							v-model="lastName" required invalid>
					</div>
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
						<input type="service" class="form-control" placeholder="which service" v-model="service"
							required invalid>
					</div>
				</div>
				...
				<div v-if="this.admin == 'true'" class="row mb-3">
					...
					<div class="col-sm-9 text-secondary">
						<input type="admin" class="form-control" placeholder="false" v-model="admin" required invalid
				...
				<div class="row">
					...
					<div class="text-center text-dark">
						<input type="submit" class="btn btn-color px-4" value="Update Profile"
							@click.prevent="() => submitForm(this.id, this.email, this.password, this.name, this.lastName, this.service, this.admin)">
					</div>
				</div>
			</div>
