  ...
  <div>
    ...
    <form v-if="false" class="form-signin">
      ...
      <button class="w-100 btn btn-lg btn-primary" type="submit"
        @click.prevent="() => signIn(this.email, this.password)">Sign in</button>
    ...
    <section class="vh-100 bg-image" style="background-image: url(../../../public/Background_Groupomania.jpg);">
              ...
              <div class="card" style="border-radius: 15px;">
                <div class="card-body p-5">
                  ...
                  <Avatar :url="this.urlAvatar"></Avatar>
                    ...
                    <div v-if="dspFormSignUp" class="form-outline mb-4">
                      <input type="text" id="form3Example2cg" class="form-control form-control-lg" v-model="lastName"
                        required invalid />
                    ...
                    <div v-if="dspFormSignUp || dspFormSignIn" class="form-outline mb-4">
                      <input type="email" id="form3Example3cg" class="form-control form-control-lg"
                        placeholder="name.lastName@groupomania.fr" v-model="email" required invalid />
                      <label class="form-label" for="form3Example3cg">Your Email</label>
                    </div>

                    <div v-if="dspFormSignUp" class="form-outline mb-4">
                      <input type="text" id="form3Example5cg" class="form-control form-control-lg" v-model="service"
                        required invalid />
                    ...
                    <div v-if="dspFormSignUp || dspFormSignIn" class="form-outline mb-4">
                      <input type="password" id="form3Example4cg" class="form-control form-control-lg"
                        v-model="password" required invalid />
                      <label class="form-label" for="form3Example4cg">Password</label>
                    </div>

                    <div v-if="dspFormSignUp" class="form-outline mb-4">
                      <input type="password" id="form3Example4cdg" class="form-control form-control-lg"
                        v-model="confirmPassword" required invalid />
                  ...
                  <label class="form-check-label" for="form2Example3g">
                    ...
                    <div v-if="dspFormSignUp" class="d-flex justify-content-center">
                      <button type="button" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"
                        @click.prevent="() => signUp(email, password, confirmPassword, name, lastName, service)">Sign
                        Up</button>
                    </div>

                    <div v-if="dspFormSignIn" class="d-flex justify-content-center">
                      <button type="button" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"
                        @click.prevent="() => signIn(email, password)">Sign In</button>
                    </div>
