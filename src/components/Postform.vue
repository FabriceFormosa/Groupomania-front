          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex flex-start align-items-center border">
                ...
                <div class="image-input m-auto" :style="{ 'background-image': `url(${imageData})` }"></div>
                <input id="file-input-test" class="file-input" ref="fileInput" type="file" @input="onSelectFile"
                  accept="image/*">
              </div>
            ...
            <div class="card-footer py-3 border-0" style="background-color: #FFFFFF;">
              <div class="d-flex flex-start w-100">
                <div class="form-outline w-100">
                  <textarea class="form-control" id="textAreaExample" rows="4" style="background: #ffff;"
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <label for="file-input-test"><i class="fa-solid fa-file-circle-plus pe-2" data-bs-toggle="tooltip"
                      title="Ajout image"></i></label>
                  <i v-if="content" @click="clearContent" class="fa-solid fa-comment-slash pe-2"
                    data-bs-toggle="tooltip" title="Suppression du message"></i>
                  <i v-if="imageData" @click="clearPicture" class="fa-solid fa-file-circle-minus"
                    data-bs-toggle="tooltip" title="Suppression image"></i>
                </div>

                <div>
                  <i v-if="content || imageData" @click="handleCklick" class="fa-solid fa-paper-plane mt-1 ms-auto "
                    data-bs-toggle="tooltip" title="Envoi du post"></i>
                </div>
              </div>
            </div>
          </div>
