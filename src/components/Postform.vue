        ...
        <div class="col-md-10 col-lg-10 col-xl-8">
          <div class="card">
            <div class="card-header d-flex flex-start align-items-center gap-2">
              ...
              <div>
                <h6 class="fw-bold mb-1 text-dark">{{ userLastName }} {{ userName }}</h6>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <i
                    v-if="content"
                    @click="clearContent"
                    class="fa-solid fa-comment-slash pe-2"
                    data-bs-toggle="tooltip"
                ...
                <div>
                  <i
                    v-if="content || imageData"
                    @click="handleCklick"
                    class="fa-solid fa-paper-plane mt-1 ms-auto"
                    data-bs-toggle="tooltip"
                    title="Envoi du post"
                  ></i>
                </div>
